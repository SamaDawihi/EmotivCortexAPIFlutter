...
Future<String> iQuerySessions(String cortexToken) async {
  // Add your function code here!

  print('iQuerySessions Start');
  ...
  channel.sink.add(
      '{ "id": 11, "jsonrpc": "2.0", "method": "querySessions", "params": { "cortexToken": "$cortexToken"}}');
  ...
  print('iQuerySessions before await');
  await completer.future; // Wait for the Future to be completed
  print('iQuerySessions after await');
